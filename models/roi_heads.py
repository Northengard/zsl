...
def fastrcnn_custom_loss(embedding_loss, class_embeddings, box_regression, labels, regression_targets):
    # type: (nn.Module, Tensor, Tensor, List[Tensor], List[Tensor]) -> Tuple[Tensor, Tensor]
    """
    Computes the loss for Faster R-CNN.
    Args:
        embedding_loss (Module or function)
    ...
    class_embeddings = class_embeddings[non_corrupted_boxes]
    box_regression = box_regression[non_corrupted_boxes]
